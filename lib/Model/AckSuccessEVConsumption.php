...
class AckSuccessEVConsumption extends AckEmploymentVerification 
{
    const DISCRIMINATOR = null;
    
    protected static $apihubModelName = 'AckSuccessEVConsumption';
    
    protected static $apihubTypes = [
        'employment_verification' => '\EmploymentVerificationSimulationClientPhp\Client\Model\SuccessEVConsumption'
    ];
